...
public class MenuButton3D : MonoBehaviour
{
    ...
    [Header("Efecto MvC3 (Mismo tama�o que el Padre)")]
    public Renderer[] ghostRenderers;

    [Tooltip("Hacia adelante (eje Y local en tu configuraci�n).")]
    ...
    [Header("Configuraci�n de Destino")]
    [Tooltip("Escribe el nombre exacto de la escena que debe cargar este bot�n espec�fico.")]
